...
class Entrepot: #Création de l'objet Entrepôt
    ...
    # Contruction de l'Entrepot, qui comporte une taille maximale, et 3 listes de pièces qui ont été traitées
    # Respectivement notées piecesA, piecesB et piecesC. 
    def __init__(self, tailleMax): # Construit une machine
    ...
    # Méthode qui récupère les pièces traitées par les machines, et incrémente le compteur lié
    ...
    def affichageGraphique(self,compteurA,compteurB,compteurC,taille_max):
        #Création de la fenêtre "resume_entrepot"
        resume_entrepot = Tk()
